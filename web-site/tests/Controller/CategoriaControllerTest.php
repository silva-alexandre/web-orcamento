...
class CategoriaControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'categorium[nome_categoria]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNome_categoria('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'categorium[nome_categoria]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNome_categoria());
    }
